...
ADD launch.json /home/project/.theia/launch.json
RUN echo "PS1=\"${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@cloudacademylabs\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ \"" >> /root/.bashrc
